...
export default function NextButton(props) {
    return (<div className="nextButton button" id={props.buttonId} onClick={props.onClick} alt="see next section">
        <p>{text.buttons.next}</p>
        <svg version="1.1" x="0px" y="0px"
            viewBox="0 0 512 512"  >
            <g>
                <g>
                    <path className="animatedStroke" d="M332.124,11.509C307.569,3.873,281.957,0,256,0C187.62,0,123.333,26.629,74.981,74.98C26.628,123.333,0,187.62,0,256
            ...
            <g>
                <g>
                    <path className="animatedStroke" d="M469.866,115.247C443,74.505,405.341,42.412,360.959,22.438c-3.782-1.704-8.234-0.016-9.936,3.769
