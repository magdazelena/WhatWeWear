...
export default function ZoomInButton(props){
    return (<div className="informativeButton button" id={props.buttonId}>
        <p>{text.buttons.zoomIn}</p>
        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
	 viewBox="0 0 512 512" >
            
                    <path className="animatedStroke" d="M331.753,11.396C307.311,3.834,281.824,0,256,0C187.62,0,123.333,26.629,74.981,74.98C26.629,123.333,0,187.62,0,256
                    ...
                    <path className="animatedStroke" d="M470.473,116.171c-26.468-40.518-63.635-72.61-107.483-92.808c-3.77-1.738-8.233-0.088-9.969,3.682
